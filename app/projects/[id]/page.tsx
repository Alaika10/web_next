          ...
          projects.map((project, idx) => (
            ...
            >
              <div className="aspect-[16/10] relative rounded-[2rem] md:rounded-[2.5rem] overflow-hidden bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm transition-all duration-700 group-hover:shadow-2xl group-hover:border-indigo-500/30">
                <img src={project.imageUrl || (project as any).image_url} alt={project.title} className="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000 opacity-80 group-hover:opacity-100" />
                <div className="absolute top-4 left-4 md:top-6 md:left-6 flex gap-2">
                   <div className="px-3 md:px-4 py-1.5 bg-black/80 backdrop-blur-md text-white font-mono-tech text-[8px] md:text-[9px] uppercase tracking-widest rounded-full border border-white/10 flex items-center gap-2">
